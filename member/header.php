...
$check_mem = "SELECT * FROM members WHERE id = '$mem_id'";
...
<head>
	...
	<title>Member Dashboard | ConstructZilla</title>
...
<body>
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo"> <img src="assets/img/loading2.gif" width="50" height="70" alt="logo"> <span class="logoclass">ConstructZilla Member</span> </a>
				<a href="index.html" class="logo logo-small"> <img src="assets/img/loading2.gif" alt="Logo" width="50" height="70"> </a>
			</div>
			<a href="javascript:void(0);" id="toggle_btn"> <i class="fe fe-text-align-left"></i> </a>
			<a class="mobile_btn" id="mobile_btn"> <i class="fas fa-bars"></i> </a>
			<ul class="nav user-menu">
			 <button onclick="window.print()"><i class="fa fa-print" style="font-size:20px;color:red"></i></button>
				<li class="nav-item dropdown noti-dropdown">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <i class="fe fe-bell"></i> <!-- <span class="badge badge-pill"></span> --> </a>
	...
	<!-- 					<div class="topnav-dropdown-header"> <span class="notification-title">Notifications</span> <a href="javascript:void(0)" class="clear-noti"> Clear All </a> </div>
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="assets/img/profiles/avatar-01.jpg" width="31" alt="Chamila Jayathunga"></span> </a>
					<div class="dropdown-menu">
						<div class="user-header">
							<div class="avatar avatar-sm"> <img src="assets/img/profiles/avatar-01.jpg" alt="User Image" class="avatar-img rounded-circle"> </div>
							<div class="user-text">
								<h6>Chamila Jayathunga</h6>
								<p class="text-muted mb-0">Member</p>
							</div>
						</div> <a class="dropdown-item" href="../Member_edit_profile.php">My Profile</a> <a class="dropdown-item" href="settings.html">Account Settings</a> <a class="dropdown-item" href="logout.php">Logout</a> </div>
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li> <a href="index.php"><i class="fas fa-tachometer-alt"></i> <span>Ads</span></a> </li>
						<li> <a href="pending_ads.php"><i class="fas fa-tachometer-alt"></i> <span>Pending Ads</span></a> </li>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Customers </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								...
								<li><a href="add_ads.php"> Add Customer </a></li>
							</ul>
						</li>
