			...
			<div class="tab-content nav">
				...
				<!-- signup -->
                    ...
                    <form action="user-otp.php" method="POST"  class="p-a30 dez-form text-center text-center">
                        ...
                        <h3 class="form-title m-t0">Code Verification</h3>
						...
						<div class="form-group">
                            <input required="" class="form-control" type="number" name="otp" placeholder="Enter verification code" style="background-color:#FCF5D8;color:#AD8C08;border:3px solid #AD8C08;"/>
                        </div>
						
                        <div class="form-group text-left "> 
							<a class="site-button red" data-toggle="tab" href="signup-user.php">Back</a>
                            <button class="site-button pull-right"  type="submit" name="check">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
