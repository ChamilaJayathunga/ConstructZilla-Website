...
$sortlink ='project.php?id='.$cat_id.'&sub_categories='.$sub_categories.'&districts='.$districts.'&local_area='.$local_area.'&str='.$str.'';
$srchlink ='project.php?id='.$cat_id.'&sub_categories='.$sub_categories.'&districts='.$districts.'&local_area='.$local_area.'';
?>
      ...
      <?php if(count($get_product)>0){?>
        ...
        <div>
         ...
         ?>
            <li>
              <label for="">
                <a href="project.php?id=<?php echo $list['id']?>&districts=<?php echo $districts?>&local_area=<?php echo $local_area?>&str=<?php echo $str ?>"><span><?php echo $list['categories'] ?></span></a>
                <?php 
                $fsfsd=$list['id'];
                $dasd=mysqli_query($con,"select id from ads where categories_id=$fsfsd"); 
              ...
              <tr class="clickable-row" data-href="ads.php?id=<?php echo $list['id']?>" style="border-bottom:1px solid rgb(182, 182, 182);cursor: pointer;">
                  <td>
                      <div style="justify-content: space-between;" class="cart-info">
                          <div style="display: flex;">
                            <a href="ads.php?id=<?php echo $list['id']?>"><img style="width: 150px;height:150px;object-fit:cover;" src="<?php echo ADS_IMAGE_SITE_PATH.$list['image']?>"></a>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <label for="tab">
     <span><a href="project.php?id=<?php echo $cat_id?>&sub_categories=<?php echo $sub_categories?>&str=<?php echo $str?>">All of Srilanka</a></span>
   </label>
   </div>
      <?php
     $i=1;
    ...
    <div class="parent-tab">
      ...
      <div class="content">
       <li><a href="project.php?id=<?php echo $cat_id?>&sub_categories=<?php echo $sub_categories ?>&districts=<?php echo $list['id']?>&str=<?php echo $str?>">All of <?php echo $list['districts']?></a></li>
       <?php
            $location_id=$list['id'];
            ...
            while($sub_area_rows=mysqli_fetch_assoc($sub_area_res)){
              echo '<li><a href="project.php?id='.$cat_id.'&sub_categories='.$sub_categories.'&districts='.$list['id'].'&local_area='.$sub_area_rows['id'].'&str='.$str.'">'.$sub_area_rows['local_area'].'</a></li>
            ';
            }
            ?>
...
<div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="parent-tab">
      <label for="tab">
     <span><a href="project.php?&districts=<?php echo $districts?>&local_area=<?php echo $local_area?>&str=<?php echo $str ?>">All Categories</a></span>
   </label>
   </div>
 ...
 <div class="parent-tab">
   ...
   <div class="content">
    <li><a href="project.php?id=<?php echo $list['id']?>&districts=<?php echo $districts?>&local_area=<?php echo $local_area?>&str=<?php echo $str ?>">All off <?php echo $list['categories']?></a></li>
    <?php
            $cat_id=$list['id'];
           ...
           echo '<li><a href="project.php?id='.$list['id'].'&sub_categories='.$sub_cat_rows['id'].'&districts='.$districts.'&local_area='.$local_area.'&str='.$str.'">'.$sub_cat_rows['sub_categories'].'</a></li>
         ';
         }
         ?>
