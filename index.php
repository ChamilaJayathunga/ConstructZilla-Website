...
?>
    ...
    <div class="page-content">
                            ...
                            <ul>
                                ...
                                <li data-index="rs-1000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slide1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    <div class="tp-caption  tp-resizeme" 
										...
										style="z-index: 13; white-space: normal; font-size: 60px; line-height: 60px; font-weight: 700; color: rgba(255, 255, 255, 1.00); border-width:0px;"> <span class="text-uppercase" style="font-family: Oswald;">We build your Dream</span> 
									</div>
                                    ...
                                    <div class="tp-caption tp-resizeme" 
										...
										style="z-index: 13; font-weight: 500; color: rgba(255, 255, 255, 0.85); border-width:0px;"> 
											<span>With a strong sense of the value of diversity, we create unique solid construct design and other exclusive solutions with architect. We are thinkers & dreamers, makers, creating lighting, installations & products for homes, education, hotels & more.</span> 
									</div>
                                    ...
                                    <div class="tp-caption tp-resizeme" 	
										...
										<a href="javascript:void(0);" class="site-button  button-skew">
											<span>Join With Us</span><i class="fa fa-angle-right"></i>
										</a> 
									</div>
                                </li>
                                <!-- SLIDE 2 -->
                                <li data-index="rs-2000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slide2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    <div class="tp-caption tp-resizeme"
										...
										style="z-index: 13; font-weight: 500; color: rgba(255, 255, 255, 0.85); border-width:0px;"> <span>With a strong sense of the value of diversity, we create unique solid construct design and other exclusive solutions with architect. We are thinkers & dreamers, makers, creating lighting, installations & products for homes, education, hotels & more.</span> </div>
                                    <!-- LAYER NR. 4 [ for readmore botton ] -->
                                    <div class="tp-caption tp-resizeme"
                                ...
                                <li data-index="rs-3000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/main-slider/slide3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    <div class="tp-caption  tp-resizeme" 
										...
										border-width:0px;"> <span>With a strong sense of the value of diversity, we create unique solid construct design and other exclusive solutions with architect. We are thinkers & dreamers, makers, creating lighting, installations & products for homes, education, hotels & more.</span> 
									</div>
                                    <!-- LAYER NR. 4 [ for readmore botton ] -->
                                    <div class="tp-caption tp-resizeme" 	
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="icon-bx-wraper left m-b30">
                                        ...
                                        <div class="icon-content">
                                            <h3 class="dez-tilte text-uppercase">Engineering</h3>
                                            <p>We provide the best Engineering Services Project for you.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="icon-bx-wraper left m-b30">
                                        <div class="icon-bx-sm bg-secondry "> <span class="icon-cell"><i class="fa fa-area-chart text-primary"></i></span> </div>
                                        <div class="icon-content">
                                            <h3 class="dez-tilte text-uppercase">Plan Making</h3>
                                            <p>Our Plan Making service provides high-end design</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="icon-bx-wraper left m-b30">
                                        ...
                                        <div class="icon-content">
                                            <h3 class="dez-tilte text-uppercase">Masonary Working</h3>
                                            <p>We are Masonary strong to build your building. </p>
                                        </div>
                                    </div>
                                </div>
								 <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="icon-bx-wraper left m-b30">
                                        <div class="icon-bx-sm bg-secondry "> <span class="icon-cell"><i class="fa fa-cubes text-primary"></i></span> </div>
                                        <div class="icon-content">
                ...
                <div class="site-filters clearfix center m-b40" id="portfolio">
                    <ul class="filters" data-toggle="buttons">
                        ...
                        <li data-filter="home" class="btn">
                            <input type="radio" >
                            <a href="#" class="site-button-secondry button-skew"><span>Engineering</span></a> </li>
                        <li data-filter="office" class="btn">
                            <input type="radio">
                            <a href="#" class="site-button-secondry button-skew"><span>Constructing</span></a> </li>
                        <li data-filter="commercial" class="btn">
                            <input type="radio">
                            <a href="#" class="site-button-secondry button-skew"><span>Plan Making</span></a> </li>
                        <li data-filter="window" class="btn">
                            <input type="radio">
                            <a href="#" class="site-button-secondry button-skew"><span>Masonary Work</span></a> </li>
                    </ul>
                </div>
                <div class="clearfix">
                            ...
                            <div class="dez-box dez-gallery-box">
                                <div class="dez-media dez-img-overlay1 dez-img-effect zoom-slow dez-img-effect zoom"> <a href="javascript:void(0);"> <img src="images/our-work/pic2.jpg"  alt=""> </a>
                                    <div class="overlay-bx">
                                        <div class="overlay-icon"> 
											<a href="project-details.html"> <i class="fa fa-link icon-bx-xs"></i> </a> 
											<span data-exthumbimage="images/our-work/thumb/pic2.jpg" data-src="images/our-work/large/pic2.jpg" class="icon-bx-xs check-km" title="Light Gallery Grid 1">		
												<i class="fa fa-picture-o"></i> 
											</span> 
										</div>
                                    </div>
        ...
        <!-- Our Projects END -->
        <!-- Architecture -->
        <div class="section-full  bg-white content-inner overlay-white-middle" style="background-image:url(images/background/bg56.jpg); background-position:right center; background-repeat:no-repeat; background-size: auto 100%;">
            <div class="container">
                <div class="section-head text-center">
                    ...
                    <p>We provide a wide variety of services including practical studies, architectural programming and project management. Definitely our work feel amazes you. You will find smoothness and accuracy in our working system.</p>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="icon-bx-wraper center m-b40 m-lr15">
                            ...
                            <div class="icon-content">
                                ...
                                <p>With the best quality and service we still concentrate on safety and protection.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="icon-bx-wraper center m-b40 m-lr15">
                            ...
                            <div class="icon-content">
                                ...
                                <p>We provide an extraordinary construction project for your dream and desires...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="icon-bx-wraper center m-b40 m-lr15">
                            ...
                            <div class="icon-content">
                                ...
                                <p>We believe in best quality over quantity. We try always best for our clients to... </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="icon-bx-wraper center m-b40 m-lr15">
                            ...
                            <div class="icon-content">
                                ...
                                <p>We first create the highest level of trust and integrity with our clients and...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="icon-bx-wraper center m-b10 m-lr15">
                            ...
                            <div class="icon-content">
                                ...
                                <p>We make our master plan by keeping the needs of the people, which is always...</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="dex-box text-primary border-2 counter-box m-b30">
                            <h2 class="text-uppercase m-a0 p-a15 "><i class="fa fa-trophy text-primary m-r20"></i> <span class="counter">1035</span></h2>
                            <h5 class="dez-tilte  text-uppercase m-a0"><span class="dez-tilte-inner skew-title bg-primary p-lr15 p-tb10">Active Experts</span></h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="dex-box text-primary border-2 counter-box m-b30">
                            <h2 class="text-uppercase m-a0 p-a15 "><i class="fa fa-group m-r20"></i> <span class="counter">1226</span></h2>
                            <h5 class="dez-tilte  text-uppercase m-a0"><span class="dez-tilte-inner skew-title bg-primary p-lr15 p-tb10">Happy Client</span></h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="dex-box text-primary border-2 counter-box m-b30">
                            <h2 class="text-uppercase m-a0 p-a15 "><i class="fa fa-thumbs-up text-primary m-r20"></i> <span class="counter">1552</span></h2>
                            <h5 class="dez-tilte  text-uppercase m-a0"><span class="dez-tilte-inner skew-title bg-primary p-lr15 p-tb10">Developer Hand</span></h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="dex-box text-primary border-2 counter-box m-b10">
                            ...
                            <h5 class="dez-tilte  text-uppercase m-a0"><span class="dez-tilte-inner skew-title bg-primary p-lr15 p-tb10">Completed Project</span></h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="dez-box m-b30">
                                ...
                                <div class="p-a15">
                                    <h4 class="dez-title m-b5 text-capitalize"><a href="javascript:;">F.S.FERNANDO</a></h4>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="dez-box m-b30">
                                ...
                                <div class="p-a15">
                                    <h4 class="dez-title m-b5 text-capitalize"><a href="javascript:;">S.H.PERERA</a></h4>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="dez-box m-b30">
                                ...
                                <div class="p-a15 bg-white">
                                    <h4 class="dez-title m-b5 text-capitalize"><a href="javascript:;">I.K.SILVA</a></h4>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="dez-box m-b10">
                                ...
                                <div class="p-a15">
                                    <h4 class="dez-title m-b5 text-capitalize"><a href="javascript:;">T.M.SENARATHNA</a></h4>
                    ...
                    <div class="blog-carousel owl-carousel owl-none">
                        <div class="item">
                            <div class="blog-post latest-blog-1 date-style-3 skew-date">
                                <div class="dez-post-media dez-img-effect zoom-slow"> <a href="javascript:;"><img src="images/blog/latest-blog/pic1.jpg" alt=""></a> </div>
                                <div class="dez-post-info p-t10">
                                    <div class="dez-post-title ">
                                        <h3 class="post-title"><a href="javascript:;">Construction Planning</a></h3>
                                    </div>
                                    <div class="dez-post-meta ">
                                        <ul>
                                            <li class="post-date"> <i class="fa fa-calendar"></i><strong>10 Aug</strong> <span> 2021</span> </li>
                                    ...
                                    <div class="dez-post-text">
                                        <p>This is our latest project which is perfectly constructed. We provide high-end residential construction, hospitals, hotels...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="blog-post latest-blog-1 date-style-3 skew-date">
                                <div class="dez-post-media dez-img-effect zoom-slow"> <a href="javascript:;"><img src="images/blog/latest-blog/pic2.jpg" alt=""></a> </div>
                                <div class="dez-post-info p-t10">
                                    <div class="dez-post-title ">
                                        <h3 class="post-title"><a href="javascript:;">Professional Services</a></h3>
                                    </div>
                                    <div class="dez-post-meta ">
                                        <ul>
                                            <li class="post-date"> <i class="fa fa-calendar"></i><strong>17 Sep</strong> <span> 2021</span> </li>
                                            <li class="post-author"><i class="fa fa-user"></i>By <a href="javascript:;">Admin</a> </li>
                                            <li class="post-comment"><i class="fa fa-comments"></i> <a href="javascript:;">0 comment</a> </li>
                                        </ul>
                                    </div>
                                    <div class="dez-post-text">
                                        <p>Our construction design provides an extraordinary construction project experience. We are able to provide our customers with a level...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="blog-post latest-blog-1 date-style-3 skew-date">
                                <div class="dez-post-media dez-img-effect zoom-slow"> <a href="javascript:;"><img src="images/blog/latest-blog/pic3.jpg" alt=""></a> </div>
                                <div class="dez-post-info p-t10">
                                    <div class="dez-post-title ">
                                        <h3 class="post-title"><a href="javascript:;">Creative construct design</a></h3>
                                    </div>
                                    <div class="dez-post-meta ">
                                        <ul>
                                            <li class="post-date"> <i class="fa fa-calendar"></i><strong>21 Oct</strong> <span> 2021</span> </li>
                                            <li class="post-author"><i class="fa fa-user"></i>By <a href="javascript:;">Admin</a> </li>
                                            <li class="post-comment"><i class="fa fa-comments"></i> <a href="javascript:;">0 comment</a> </li>
                                        </ul>
                                    </div>
                                    <div class="dez-post-text">
                                        <p>We understand the importance of the creation and professionalism and work with the best creative team memeber to achieve this goal...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonial-four owl-theme owl-carousel">
                        <div class="item">
                            <div class="testimonial-4 testimonial-bg">
                                ...
                                <div class="testimonial-text">
                                    <p>The entire team is extremely creative and forward thinking. They are also very quick and efficient when executing changes for us.</p>
                                </div>
                                <div class="testimonial-detail"> <strong class="testimonial-name">S.G.Fernando</strong> <span class="testimonial-position">Media Specialist</span> </div>
                        ...
                        <div class="item">
                            <div class="testimonial-4 testimonial-bg">
                                ...
                                <div class="testimonial-text">
                                    <p>I found their expertise to be extremely helpful. I think it is awesome and I can't thank you enough for working so closely.</p>
                                </div>
                                <div class="testimonial-detail"> <strong class="testimonial-name">S.K.Perera</strong> <span class="testimonial-position">Senior Specialist</span> </div>
                                <div class="quote-right"></div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimonial-4 testimonial-bg">
                                ...
                                <div class="testimonial-detail"> <strong class="testimonial-name">F.K.Silva</strong> <span class="testimonial-position">Media Specialist</span> </div>
                                <div class="quote-right"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="client-logo-carousel owl-carousel owl-btn-center-lr">
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo"><a href="#"><img src="images/client-logo/logo1.png" alt=""></a></div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo"> <a href="#"><img src="images/client-logo/logo2.png" alt=""></a> </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ow-client-logo">
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo"> <a href="#"><img src="images/client-logo/logo3.png" alt=""></a> </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo"> <a href="#"><img src="images/client-logo/logo4.png" alt=""></a> </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo"> <a href="#"><img src="images/client-logo/logo6.jpg" alt=""></a> </div>
                            </div>
                        </div>
                    </div>
                </div>
