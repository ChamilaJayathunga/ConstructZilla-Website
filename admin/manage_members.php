...
<br>
<center><h1>Member Proof Details</h1></center>
<h6>Name</h6>
<div class="form-group">
    <input value="<?php echo $row['name'] ?>" type="text" disabled required>
</div>
<h6>Role</h6>
<div class="form-group">
    <input value="<?php echo $row['role'] ?>" type="text" disabled required>
</div>
<h6>NIC Image</h6>
<div class="form-group">
